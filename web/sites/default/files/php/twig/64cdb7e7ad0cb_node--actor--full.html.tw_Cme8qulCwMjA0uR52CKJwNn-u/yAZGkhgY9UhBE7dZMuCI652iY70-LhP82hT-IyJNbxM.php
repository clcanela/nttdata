...
/* themes/cartelera/templates/node--actor--full.html.twig */
class __TwigTemplate_e5994824254fe0c5132e31c6cef7cb2c extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 80, $this->source)))) : (""))];
  ...
  <div";
    ...
    ";
        // line 108
        echo "    ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_picture", [], "any", false, false, true, 108), 108, $this->source), "html", null, true);
        echo "
    <h3 class=\"white-title\">";
        // line 109
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Movies"));
        echo "</h3>
    ";
        // line 110
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["movies_of_view"] ?? null), 110, $this->source), "html", null, true);
        echo "
    ";
        // line 111
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_biography", [], "any", false, false, true, 111), 111, $this->source), "html", null, true);
        echo "
  </div>
  ";
        // line 113
...
";
    ...
    {
        return "themes/cartelera/templates/node--actor--full.html.twig";
    }
    ...
    {
        return array (  165 => 118,  159 => 115,  154 => 114,  152 => 113,  147 => 111,  143 => 110,  139 => 109,  134 => 108,  130 => 106,  127 => 105,  121 => 102,  109 => 100,  104 => 99,  98 => 96,  95 => 95,  93 => 94,  90 => 93,  88 => 92,  83 => 91,  75 => 88,  70 => 87,  68 => 86,  64 => 85,  60 => 84,  55 => 83,  53 => 80,  52 => 79,  51 => 78,  50 => 77,  49 => 76,  48 => 75,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <div{{ content_attributes.addClass('node__content', layout) }}>
    ...
    <h3 class=\"white-title\">{{ 'Movies'|t }}</h3>
    {{ movies_of_view }}
...
", "themes/cartelera/templates/node--actor--full.html.twig", "/var/www/html/web/themes/cartelera/templates/node--actor--full.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70, "if" => 86, "apply" => 100);
        static $filters = array("clean_class" => 70, "escape" => 83, "t" => 100, "spaceless" => 100);
